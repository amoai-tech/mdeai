---
name: linear-pm
description: DEPRECATED — use the `linear` skill instead. Linear project management - issues, projects, cycles, and roadmaps. Use for Linear-related tasks like managing issues, tracking sprints, and organizing projects.
version: 1.1.0
category: 'Other'
...
> All content from `linear-pm` was merged into `.agents/skills/linear/` (SKILL.md +
