...
linear_label: COMM
linear_issue: SAN-656
linear_url: https://linear.app/sanjiovani/issue/SAN-656
...
official_refs:
  - https://supabase.com/docs
  - https://docs.medusajs.com
description: "Ship trip product links as one small commerce PR after its dependencies are green."
---
...
**Easy description:** Ship trip product links as one small commerce PR after its dependencies are green.

**Goal:** Link trips and itinerary items to live Medusa products.
...
```bash
rg -n "commerce_trip_products" mdeapp/supabase/migrations mdeapp/src
