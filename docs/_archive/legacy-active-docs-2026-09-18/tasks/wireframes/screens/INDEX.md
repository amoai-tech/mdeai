...
| `/cafes` | [venues/028-scr](../venues/008-scr-cafes-browse-page.md) | SAN-519 | Not Started |
| `/rentals` | [real-estate/REAL-011](../real-estate/009-scr-rentals-browse-page.md) | SAN-478 | Not Started (redirect today) |
| `/host/events` | [EVP-014-core](../../events/tasks/MVP/EVP-014-core-host-events-list-page.md) | SAN-118 | Not Started |
...
*Last updated: 2026-06-04 — post audit corrections; verify script at repo `scripts/verify-scr-wire-pairing.mjs`*
