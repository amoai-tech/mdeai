...
| **Venue booking schema decision** | SAN-492 `partner_locations` reuse model — decision matrix, RLS plan, exact SQL (Appendix A), constraint deltas, status mapping, readiness | [`./VENUE-DATA-MODEL.md`](./VENUE-DATA-MODEL.md) |
...
| **Venue model forensic audit (current)** | VENUE-DATA-MODEL vs live + PR #146 · E0/E1 blockers | [`./data-model-audit.md`](./data-model-audit.md) |
| **Live forensic audit (all tables)** | 90/100 A- · prod probes · ownership classification | [`../audit/05-all-events-data-model-live-audit.md`](../audit/05-all-events-data-model-live-audit.md) |
