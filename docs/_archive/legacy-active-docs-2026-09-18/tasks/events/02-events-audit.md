...
| **Linear hygiene** | 95% | 🟢 | CTEST moved · EVT titles fixed · AIE frontmatter complete |
...
| T16 | CTEST off EP | `project:Events Platform query:CTEST` | 🟢 **0** (moved to Growth & Operations) |
| T17 | AIE frontmatter | all `AIE-*.md` have `linear: SAN-*` | 🟢 **32/32** |
