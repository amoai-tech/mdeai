...
* **Task:** `tasks/contest/tasks/CTEST-000-diagrams-repo-decisions.md`
* **Diagrams source:** `tasks/contest/docs/01-mermaid-diagrams.md`
* **Spec score:** 100/100 (verified 2026-06-02)
* **MVP track:** MVP-A · **Phase:** Phase 2+

## Audit

* [Spec verification](https://github.com/amo-tech-ai/mdeai/blob/main/tasks/contest/audit/2026-06-02-spec-verification.md)
* Pack execution readiness ~15/100 until CTEST-001+ land in `mdeapp/`

## Scope

Diagrams, GitHub repo decisions, and scope gate — docs-only (no `mdeapp/src` changes).

## Done gate

* `tasks/contest/notes/CTEST-000-evidence.md`
* Mermaid + link validation recorded (`rg -c '^```mermaid' tasks/contest/docs/01-mermaid-diagrams.md` → ≥ 7)

---

# Contest implementation diagrams

Authoritative copy in repo: `tasks/contest/docs/01-mermaid-diagrams.md`. Linear renders Mermaid in fenced blocks below.
