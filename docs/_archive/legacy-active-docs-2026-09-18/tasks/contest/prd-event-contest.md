...
related_architecture: ./docs/architecture.md
...
Full details are in [architecture.md](./docs/architecture.md). Product-level ownership:
...
Detailed architecture lives in [architecture.md](./docs/architecture.md). Workflow catalog:
...
Full roadmap is in [roadmap.md](./docs/roadmap.md).
...
Additional architecture diagrams are in [architecture.md](./docs/architecture.md).
