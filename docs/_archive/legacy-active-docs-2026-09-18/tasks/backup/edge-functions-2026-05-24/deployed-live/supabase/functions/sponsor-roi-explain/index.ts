 ...
 * Auth: Bearer JWT (scoped to application) OR Bearer SPONSOR_ROI_CRON_SECRET (cron).
...
The sponsor for "${appResult.data.events?.name ?? "this event"}" has the following results over the last 7 days:
