...
const TOOLS: Record<string, ToolExecutor> = {
  ...
  capture_lead: {
    ...
    execute: (ctx) =>
      executeCaptureLead(ctx.params, ctx.userId, ctx.conversationId ?? null),
  },
  search_events: {
    definition: {
      name: "search_events",
...
async function executeCaptureLead(
  ...
  const row = buildLeadCaptureInsert({
    ...
    phone: typeof params.phone === "string" ? params.phone : null,
    name: typeof params.name === "string" ? params.name : null,
    neighborhood: typeof params.neighborhood === "string" ? params.neighborhood : null,
    budget_max: typeof params.budget_max === "number" ? params.budget_max : null,
    move_in_date: typeof params.move_in_date === "string" ? params.move_in_date : null,
    listing_id: typeof params.listing_id === "string" ? params.listing_id : null,
  });
