---
parent: supabase
title: Supabase Skill Feedback Issue Template
description: GitHub issue body template for upstream supabase/agent-skills feedback. Used by skill-feedback.md.
internal: true
---
