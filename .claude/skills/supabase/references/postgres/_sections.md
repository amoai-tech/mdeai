---
parent: supabase
title: Postgres Rules — Section Index
description: Category definitions for references/postgres/*.md rule files. Internal index for the vendored Supabase postgres best-practices pack.
internal: true
---
