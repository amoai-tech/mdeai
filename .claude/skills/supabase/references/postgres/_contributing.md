---
parent: supabase
title: Postgres Rules — Authoring Guide
description: How to write references/postgres/*.md rule files. Internal — only when extending the vendored postgres pack.
internal: true
---
