...
These rules were carried over when **`google-maps-api`** was folded into **`maps`**. Command reference: [`all-apis.md`](all-apis.md). Script path: **`.claude/skills/maps/scripts/gmaps.py`** (moved from legacy `google-maps-api/scripts/` on 2026-05-14).
