...
parent_skill: maps
topic: maps-grounding
description: "Offline Google Maps Platform doc export (maps-grounding). Tertiary: verify against live developers.google.com and curated references/*.md."
---
