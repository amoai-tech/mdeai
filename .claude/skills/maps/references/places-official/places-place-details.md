...
parent_skill: maps
topic: place-details-new
description: "Places API (New) — Place Details fields and requests. Tertiary: verify billing, field names, and schemas against live developers.google.com and curated references/places-api-web-service.md."
--- 
