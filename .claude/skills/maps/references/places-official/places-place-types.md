...
parent_skill: maps
topic: place-types
description: "Places API (New) — place type tables and filters. Tertiary: verify billing, field names, and schemas against live developers.google.com and curated references/places-api-web-service.md."
---
...
|---|---|
| - [Automotive](https://developers.google.com/maps/documentation/places/web-service/place-types#automotive) - [Business](https://developers.google.com/maps/documentation/places/web-service/place-types#business) - [Culture](https://developers.google.com/maps/documentation/places/web-service/place-types#culture) - [Education](https://developers.google.com/maps/documentation/places/web-service/place-types#education) - [Entertainment and Recreation](https://developers.google.com/maps/documentation/places/web-service/place-types#entertainment-and-recreation) - [Facilities](https://developers.google.com/maps/documentation/places/web-service/place-types#facilities) - [Finance](https://developers.google.com/maps/documentation/places/web-service/place-types#finance) - [Food and Drink](https://developers.google.com/maps/documentation/places/web-service/place-types#food-and-drink) - [Geographical Areas](https://developers.google.com/maps/documentation/places/web-service/place-types#geographical-areas) - [Government](https://developers.google.com/maps/documentation/places/web-service/place-types#government) | - [Health and Wellness](https://developers.google.com/maps/documentation/places/web-service/place-types#health-and-wellness) - [Housing](https://developers.google.com/maps/documentation/places/web-service/place-types#housing) - [Lodging](https://developers.google.com/maps/documentation/places/web-service/place-types#lodging) - [Natural Features](https://developers.google.com/maps/documentation/places/web-service/place-types#natural-features) - [Places of Worship](https://developers.google.com/maps/documentation/places/web-service/place-types#places-of-worship) - [Services](https://developers.google.com/maps/documentation/places/web-service/place-types#services) - [Shopping](https://developers.google.com/maps/documentation/places/web-service/place-types#shopping) - [Sports](https://developers.google.com/maps/documentation/places/web-service/place-types#sports) - [Transportation](https://developers.google.com/maps/documentation/places/web-service/place-types#transportation) |
...
Type collections can be used as the `includedPrimaryTypes` value in
Autocomplete (New) requests. Using a type collection returns all results
that match any of the associated included types. Type collections can't be
specified with any other type values.

> [!NOTE]
> **Note:** For better results, users should select specific types from [Table A](https://developers.google.com/maps/documentation/places/web-service/place-types#table-a) and [Table B](https://developers.google.com/maps/documentation/places/web-service/place-types#table-b).
